                ...
                <div class="carousel-content">
                  <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
                      <p class="text-white text-s-size-20 text-m-size-40 text-l-size-60 margin-bottom-40 text-thin text-line-height-1">Appartement de colocation</p>
                      <p class="text-white text-size-16 margin-bottom-40">Bon site de colocation.<br>Crois-moi.</p>
                    </div>                  
                  </div>
                </div>
              </div>
              ...
              <div class="s-12 center">
                ...
                <div class="carousel-content">
                  <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
                      <p class="text-white text-s-size-20 text-m-size-40 text-l-size-60 margin-bottom-40 text-thin text-line-height-1">Appartement de colocation</p>
                      <p class="text-white text-size-16 margin-bottom-30">Bon site de colocation. Crois-moi.</p>
                    </div>                  
                  </div>
                </div>
              </div>

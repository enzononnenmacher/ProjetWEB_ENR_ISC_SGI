                                ...
                                <div class="margin">
                                    <div class="s-12 m-12 l-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="file" name="inputPictures" id="inputPictures" accept="image/x-png,image/gif,image/jpeg" value=<?= $article['inputPictures'] ?> required multiple>
                                        </div>
                                        <div class="form-group">
